...
export function SidebarRight() {
  ...
  return (
    ...
    >
      ...
      <div className="bg-card border border-border rounded-2xl p-4">
        ...
        <div className="space-y-4">
          {suggested.map((user, i) => (
            <div
              key={i}
              className="flex items-center justify-between hover:bg-muted p-2 rounded-lg transition"
            >
      ...
      <div className="bg-card border border-border rounded-2xl p-4">
        ...
        <div className="space-y-4">
          {trending.map((trend, i) => (
            <div
              key={i}
              className="pb-3 border-b border-border cursor-pointer hover:bg-muted p-2 rounded-lg transition"
            >
              <div className="text-xs text-muted-foreground">
                {trend.category}
              </div>
      ...
      {/* AI Activity */}
      <div className="bg-primary/5 border border-primary/20 rounded-2xl p-4 transition-colors">
