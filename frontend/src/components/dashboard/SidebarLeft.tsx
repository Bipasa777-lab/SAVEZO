...
export function SidebarLeft() {
  ...
  return (
    ...
    >
      {/* NAVIGATION */}
      <div>
        <p className="text-[11px] text-muted-foreground tracking-widest mb-3 px-2">
          NAVIGATION
        </p>
            ...
            if (isExternal) {
              return (
                <div
                  ...
                  onClick={() =>
                    window.open(
                      "https://www.google.com/search?q=AI+post+detection",
                      "_blank"
                    )
                  }
        ...
        {/* GROUPS */}
        <p className="text-[11px] text-muted-foreground tracking-widest mt-8 mb-3 px-2">
          MY GROUPS
        </p>
